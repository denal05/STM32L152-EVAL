...
/* Initialize the LCD */ 
  ...
  LCD_DisplayStringLine( Line2, "     DMA/ADC_TIM2   " );
  LCD_DisplayStringLine( Line3, "                    " );
  LCD_DisplayStringLine( Line4, "INSTRUCTIONS:       " );
  LCD_DisplayStringLine( Line5, "Use pot. RV3 and    " );
  LCD_DisplayStringLine( Line6, "connect PA.00       " );
  LCD_DisplayStringLine( Line7, "(TIM2_CH1) pin to an" );
  LCD_DisplayStringLine( Line8, "oscilloscope.       " );
#endif 
