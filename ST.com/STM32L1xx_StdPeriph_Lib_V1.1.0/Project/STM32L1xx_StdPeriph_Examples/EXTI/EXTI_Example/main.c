...
int main(void)
{
  ...
  LCD_DisplayStringLine( Line2, " External Interrupt " );
  LCD_DisplayStringLine( Line3, "                    " );
  LCD_DisplayStringLine( Line4, "INSTRUCTIONS:       " );
  LCD_DisplayStringLine( Line5, "Use KEY button and  " );
  LCD_DisplayStringLine( Line6, "joystick SELECT, UP " );
  LCD_DisplayStringLine( Line7, "and DOWN for LED1,  " );
  LCD_DisplayStringLine( Line8, "LED2, LED3, and LED4" );
#endif 
