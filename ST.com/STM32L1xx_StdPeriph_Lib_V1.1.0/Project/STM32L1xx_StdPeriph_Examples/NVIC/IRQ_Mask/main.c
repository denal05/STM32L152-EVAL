...
int main(void)
{
  ...
  LCD_DisplayStringLine( Line2, "    NVIC/IRQ_Mask   " );
  LCD_DisplayStringLine( Line3, "                    " );
  LCD_DisplayStringLine( Line4, "INSTRUCTIONS:       " );
  LCD_DisplayStringLine( Line5, "Press KEY button to)" );
  LCD_DisplayStringLine( Line6, "enable/disable IRQ. " );
  LCD_DisplayStringLine( Line7, "Press SELECT button " );
  LCD_DisplayStringLine( Line8, "to mask/unmask IRQ  " );
  LCD_DisplayStringLine( Line9, "with 0x40.          " );
