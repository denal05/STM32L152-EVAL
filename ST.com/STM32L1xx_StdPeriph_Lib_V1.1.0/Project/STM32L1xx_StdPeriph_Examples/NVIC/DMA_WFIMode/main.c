...
int main(void)
{
  ...
  LCD_DisplayStringLine( Line2, "   NVIC/DMA_WFIMode " );
  LCD_DisplayStringLine( Line3, "                    " );
  LCD_DisplayStringLine( Line4, "INSTRUCTIONS:       " );
  LCD_DisplayStringLine( Line5, "Press KEY button to " );
  LCD_DisplayStringLine( Line6, "enter WFI mode, then" );
  LCD_DisplayStringLine( Line7, "send 0, 1, 2, 3, 4, " );
  LCD_DisplayStringLine( Line8, "5, 6, 7, 8, 9 from  " );
  LCD_DisplayStringLine( Line9, "USART2 @115200 baud " );
