...
static __IO uint8_t StandbyModeStatus = 0x00;
/**
  * @}
  */
...
void Demo_Init(void)
{
  ...
  {// System resumed from STANDBY mode
    ...
    // ADC Get convertion value
    ////IDD_Measurement_Standby();
...
void Demo_GPIOConfig(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0; /* = IDD_WAKEUP_PIN; */
  GPIO_Init(GPIOA /* (IDD_WAKEUP_GPIO_PORT */, &GPIO_InitStructure);
